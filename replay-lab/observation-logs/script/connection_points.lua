...
M.get_storage_tank_connection_points = function(entity)
...
M.get_chemical_plant_connection_points = function(plant)
    local positions = {}
...
M.get_generator_connection_positions = function(entity)
    local x, y = entity.position.x, entity.position.y
...
M.get_pumpjack_connection_points = function(entity)
    local x, y = entity.position.x, entity.position.y
    local orientation = entity.orientation
...
M.get_boiler_connection_points = function(entity)
    local x, y = entity.position.x, entity.position.y
...
M.get_offshore_pump_connection_points = function(entity)
    local x, y = entity.position.x, entity.position.y
    local orientation = entity.orientation * 8
...
M.get_refinery_connection_points = function(refinery)
